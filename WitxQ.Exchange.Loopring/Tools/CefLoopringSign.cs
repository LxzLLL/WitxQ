...
namespace WitxQ.Exchange.Loopring.Tools
{
    ...
    /// 嵌套CEF的签名（调用js）
    /// </summary>
    //public class CefLoopringSign : IDisposable
    //{
    //    /// <summary>
    //    /// hash和sign的URL
    //    /// </summary>
    ...
    //    {
    //        ExLoopring.LOGGER.Info($"Cef ChromeBrowser BrowserInitialized！The Url Is {this._signUrl}");
    ...
    //    {
    //        ExLoopring.LOGGER.Info($"Cef Browser FrameLoadEnd！");
    //        ChromiumWebBrowser browser = sender as ChromiumWebBrowser;
    //        if (e.Frame.IsMain)
    //        {
    //            ExLoopring.LOGGER.Info($"Cef Browser Main Frame Loaded！");
    //            //HashTest();
    //            //SignHashTest();
    //        }
    //        else
    ...
    //    {
    //        Cef.Shutdown();
    //        ExLoopring.LOGGER.Info("CEF Shutdown!");
    //    }
